data{
  ...
  //Triad info:
  int hm_triads;
  vector[3] calcobs[hm_triads]; //these are just the true values, should be turned into a noisy calcobs locally with noise level estimated from pairs?
  /* int hm_ordobs; */ //tried just passing 0 here, doesn't work, so, copy-paste time. Sigh. Oh well.
