...
for(i in 1:5){
    x11();
    print( cloudplot(fit_allords,i)+endorsementplot(fit_allords,i,"allords")+endorsementplot(fit_sansords,i,"sansords")+endorsementplot(fit_matchords,i,"matchsords"))
}
