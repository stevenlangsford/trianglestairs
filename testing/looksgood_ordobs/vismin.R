...
(ggplot(data=NULL,aes(x=a,y=b))+
 geom_point(data=targ.attr.ests1,color="red",alpha=.3)+
 geom_point(data=data.df[stim1,],color="black",size=6)+
 geom_point(data=data.df[stim1,],color="red",size=5)+
 geom_point(data=targ.attr.ests2,color="blue",alpha=.3)+
 geom_point(data=data.df[stim2,],color="black",size=6)+
 geom_point(data=data.df[stim2,],color="blue",size=5)+
 geom_point(data=targ.attr.ests3,color="green",alpha=.3)+
 geom_point(data=data.df[stim3,],color="black",size=6)+
 geom_point(data=data.df[stim3,],color="green",size=5)+
 theme_bw())
...
##     geom_vline(xintercept=data.df$value[stim1])+
##     theme_bw())
